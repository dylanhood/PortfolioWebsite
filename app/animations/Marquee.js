import NormalizationWheel from 'normalize-wheel'
...
import { getPffset } from 'utils/dom'
...
export default class extends Component {
    ...
    update () {
        ...
        each(this.elements.items, (element, index) => {
            element.postion = -this.scroll.current - element.extra
    ...
    onResize () {
        ...
        this.widthTotal = this.element.getBoundClientRect().width
