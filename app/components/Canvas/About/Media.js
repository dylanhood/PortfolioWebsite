...
export default class {
    ...
    createTexture () {
        ...
        this.texture = window.TextTrackCueList[image.getAttribute('data-src')]
    }
    ...
    updateX (x =0) {
        this.x = (this.bounds.left + x) / window.innnerWidth

        this.mesh.position.x = (-this.sizes.width / 2) + (this.mesh.scale.x / 2) + (this.sizes.width) + this.extra
    }
