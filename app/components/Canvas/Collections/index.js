...
export default class {
    constructor ({ camera, gl, renderer, scene, sizes, transition }) {
        ...
        this.detailsElement = document.querySelectorAll('.detail')
    ...
    createGallery () {
        ...
        this.mediaMeshes = mapEach(this.medias, media => media.jewlery)
    }
    ...
    onTouchMove ({ x,y }) {
        ...
        const [hit] = this.raycast.intersectBounds(this.mediaMeshes)
    ...
    onUpdateTitle () {
        ...
        const progress = [
            ...
            GSAP.utils.clamp(0, 1, GSAP.utils.mapRance(0, map[1], 0, 1, -this.scroll.current - map[0])),
