...
export default class extends Component {
    ...
    createBounds ({ sizes }) {
        ...
        this.collectionBounds = this.element.getBoundingClientRect()
    ...
    updateX (scroll = 0) {
        ...
        this.group.position.x = (-this.sizes.width / 2) + (this.jewelry.scale.x / 2) + (this.sizes.width)
    ...
    update (scroll, index) {
        ...
        if (this.animation > 0.01) {
            ...
            this.model.program.dethWrite = false
        } else {
