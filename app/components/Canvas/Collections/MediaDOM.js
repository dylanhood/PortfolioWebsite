...
export default class Navigation extends Component {
    constructor ({ element }) {
        super({
            ...
            elements: {
                ...
                size: '.detai__information__highlight:first-of-type .detail__information__highlight__text',
                ...
                sizeconLine: '.detail__information__highlight__icon--arrow path:nth child(1)',
                sizeSpans: [],

                star: '.detail__information__highlight:last-of-type .detail__information__highlight__text',
                starIcon: '.detail__informaton__highlight__icon--star',
    ...
    createInfo () {
        ...
        this.expression.infoSpans = this.elements.info.querySelectorAll('span span')
    }
    ...
    createDisclaimer () {
        ...
        this.elements.disclaimerSpans = this.elements.disclaimer.querySelctorAll('span span')
    }
    ...
    animateIn () {
        ...
        mapEach(this.elements.sizeLines, (elements, index) => {
        ...
        this.timelineIn.fromTo(this.elements.sizeIconPaths[0], {
            autoAlpha: 0,
        ...
        this.timelineIn.fromTo(this.elements.sizeIconPaths[1], {
            autoAlpha: 0,
            transformOrigin: '50% 50%',
            x: '50%'
        }, {
        ...
        this.timelineIn.fromTo(this.elements.sizeIconLine, {
            autoAlpha: 0,
            scale: 0,
            transformOrigin: '50% 50%'
        }, {
        ...
        this.timelineIn.fromTo(this.elements.starIconPath, {
            autoAlpha: 0,
            scale: 0.5,
            transformOrigin: '50% 50%'
        }, {
        ...
        this.timelineIn.fromTo(this.elements.infoLabel, {
            y: '100%'
        }, {
            duration: 1,
            ease,
    ...
    onResize () {
        ...
        window.requestAnimationFrame(_ => {
            window.requestAnimationFrame(_ => {
                ...
                this.elements.startLines = calculate(this.elements.starSpans)
                this.elements.infoLines = calculate(this.elements.infoSpans)
                this.elements.disclaimerLines = calculate(this.elements.disclaimerSpans)
            })
        })
    }
