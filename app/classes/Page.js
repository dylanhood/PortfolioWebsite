...
export default class extends EventEmitter {
    constructor ({ classes, element, elements, isScrollable = true }) {
        ...
        this.selectors = {
            ...
            elements: {
                ...
                animationMagnetics: '[data-animation="magnetic"]',
                animationParallaxes: '[data-animation="parallax"]',
                animationParagraphs: '[data-animation="paragraph"]',
                animationRotations: '[data-animation="rotation"]',
                animationsTranslates: '[data-animation="translates"]',
    ...
    create () {
        ...
        each(this.selectors.elements, (selector, key) => {
            if (selector instanceof window.HTMLElement || selector instanceof window.NodeList) {
                ...
                this.element[key] = this.element.querySelectorAll(selector)
    ...
    this.animatonsButtons = mapEach(this.elements.animationsButtons, (element, index) => {
        return new Button({
            element
        })
    })
    ...
    this.animations.push(...this.animationsMagentics)

    /**
     * Parallaxes.
     */

    this.aniamtionsParallaxes = mapEach(this.elements.animationsParallaxes, element => {
    ...
    this.animations.push(...this.animationsTranlates)
}
...
set (value) {
    ...
    this.transformPrefix(this.elements.wrapper, this.scroll.current)
}
